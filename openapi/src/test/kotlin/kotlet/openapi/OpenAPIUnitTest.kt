    ...
    fun `should return OpenAPI with one method`() {
        val routing = Kotlet.routing {
            ...
            post("/post/{postId}/comments/{commentId}") { call ->
                ...
                pathParameters<CommentPostPath>()
                            ...
                            "schema" : {
                              ...
                              "properties" : {
                                "comments" : {
                                  ...
                                  "description" : "Map of class kotlet.openapi.Comment"
                                },
                                "content" : {
                                  "type" : "string",
                                  "nullable" : true
