...
inline fun <reified T : Any> HttpCall.receiveQuery(): T {
    ...
    // However, it is absolutely unclear how to "fit" such a data structure into a data-class, so for such
    // multi-parameters we take only the very first one and that's it
