...
internal class OptionalParamSegmentSelector(internal val parameterName: String) : Selector {
    ...
    override fun evaluate(
        ...
        // 1) Pattern is /user/{userId?} and path is /user/123.
        // In this case segmentIndex has to be less than pathSegments.size
        // 2) Pattern is /user/{userId?} and path is /user.
        // In this case segmentIndex has to be equal to pathSegments.size
